...
import TradeRecommendationList from '@/components/trading/TradeRecommendationList';
  ...
  return (
    ...
    >
      <PageTransition className="h-full flex flex-col gap-4">
        {/* Trade recommendations from Axon pipeline */}
        <ErrorBoundary fallback="trading">
          <TradeRecommendationList />
        </ErrorBoundary>
